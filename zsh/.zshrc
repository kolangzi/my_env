...
# Homebrew 설치 경로 확인 (Apple Silicon vs Intel)
...
if [ -n "$FZF_BASE" ]; then
    ...
    # fd 명령어를 이용한 검색 설정 (숨김 파일 포함, .git 제외)
    export FZF_CTRL_T_COMMAND="fd --type f --hidden --follow --exclude .git"
    export FZF_ALT_C_COMMAND="fd --type d --hidden --exclude .git"

    # Zsh 전용 키 바인딩 (Ctrl-t, Ctrl-r, Alt-c 활성화)
...
alias pip3='/opt/homebrew/opt/python@3.13/bin/pip3.13'
